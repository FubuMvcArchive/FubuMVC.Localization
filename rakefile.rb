...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Localization"
COPYRIGHT = 'Copyright 2012 FubuMVC.Localization. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Localization.sln', :clrversion => CLR_TOOLS_VERSION
